...
You can also find examples of running the package at [folder Notebooks](https://github.com/peng-lab/PyBaSiC/tree/main/Notebooks). Data used in the examples and a description can be downloaded from [Dropbox](https://www.dropbox.com/s/plznvzdjglrse3h/Demoexamples.zip?dl=0)
